<template xmlns:v-on="http://www.w3.org/1999/xhtml">
    ...
    >
        <template slot="toolbar-contents">
            <v-btn v-if="id && !deployStatus" @click="generateRestService">
                <v-icon>flash_on</v-icon>
                Generate REST service
            </v-btn>
            <v-button v-if="id && deployStatus" @click="showRestServiceProgress">
                <md-spinner v-if="'view app'!=deployStatus" :md-size="20" md-indeterminate
